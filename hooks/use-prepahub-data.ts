...
import { lastStorageWriteFailure, localData, readFlag, writeFlag, type Chapter, type DailyCheckin, type DayPlanRecord, type Grade, type Preferences, type ReviewItem, type WeekSnapshot, type WorkItem } from "@/lib/storage";
...
export function usePrepahubData() {
  ...
  return { ...data, refresh, saveSessions, removeSession, saveExercises, saveWorkItems, saveGrades, saveReviewItems, saveCheckins, saveChapters, savePreferences };
}
