...
/** Filtre matière + période, combinables (ET logique). */
...
/*
 * Plus de `sessionsForExercise` ni de `resultCounts` (taux de réussite) : ils
 * lisaient `exercise_id`/`result`, que seule l'ancienne banque d'exercices
 * renseignait. La banque retirée, l'historique ne parle plus que de temps.
 */
