...
export interface Exercise { id: string; subject: Subject; chapter: string; source: string; difficulty: Difficulty; status: ExerciseStatus; duration_minutes: number; note: string | null; created_at: string; }
