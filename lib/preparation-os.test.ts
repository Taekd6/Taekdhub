...
let id = 0;
const exercise = (subject: Exercise["subject"], mastery: Exercise["mastery"] = 0): Exercise => ({ id: `prep-${++id}`, subject, title: `Ex ${id}`, statement: "", chapter_id: null, source: "test", year: null, competition: null, programme_level: null, license_status: null, external_id: null, source_url: null, prerequisites: [], pedagogical_goal: null, level: null, type: "TD", difficulty: 2, mastery, status: mastery === 100 ? "maîtrisé" : "à faire", estimated_minutes: 20, attempts: mastery === 100 ? 1 : 0, note: null, created_at: "2026-01-01T00:00:00.000Z", updated_at: "2026-01-01T00:00:00.000Z", tags: [], favorite: false, archived: false, hints: [], correction: null, last_worked_at: mastery === 100 ? "2026-08-29T00:00:00.000Z" : null });
