      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-2">
        {recommendations.map(({ exercise, reasons }) => (
          <button
            ...
            className="focus-ring flex min-w-0 items-center justify-between gap-3 rounded-xl border border-hairline/[0.06] p-3 text-left transition hover:border-hairline/[0.14] hover:bg-hairline/[0.02]"
          >
